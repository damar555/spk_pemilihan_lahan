                            ...
                            <div class="card-header">
                                <div class="card-header-action">
                                    <h4 class="font-weight-bold text-primary"> Edit Profil
                                        <a href="<?= base_url('profilcontrol/user') ?>" class="btn btn-danger float-right">Kembali<i class="fas fa-chevron-right"></i></a>
                                    </h4>
                                </div>
                            </div>
                            <div class="card-body">
                            <form action="<?php echo base_url('Profilcontrol/proses_edit_user'); ?>" method="POST">
