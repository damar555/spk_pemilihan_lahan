        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?= base_url('datakriteria') ?>">
                    <i class="fas fa-fw fa-solid fa-dice"></i>
                    <span>Data Kriteria</span></a>
            </li>

            <!-- Nav Item - Data Sub Kriteria -->
            <li class="nav-item active">
                <a class="nav-link" href="<?= base_url('datasubkriteria') ?>">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?= base_url('datapenilaian') ?>">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?= base_url('dataperhitungan') ?>">
            ...
            <!-- Nav Item - Data Hasil -->
            <li class="nav-item active">
                <a class="nav-link" href="<?= base_url('dataperhitungan/hasil') ?>">
            ...
            <!-- Nav Item - Data User -->
            <li class="nav-item active">
                <a class="nav-link" href="<?= base_url('profilcontrol') ?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="<?= base_url('profilcontrol') ?>">
